...
export default function Sidebar({ meName, onLogout, selectedView, setSelectedView }: SidebarProps) {
  const menuItems = [
  ...
  return (
    <aside className="w-80 bg-white border-r border-slate-100 flex flex-col min-h-screen relative z-10">
      ...
      <div className="h-24 px-8 border-b border-slate-50 flex items-center justify-between">
        ...
        />
        <span className="text-[9px] uppercase font-black tracking-widest text-[#04693F] border-l border-slate-200 pl-3">
          ERP
        </span>
      </div>
